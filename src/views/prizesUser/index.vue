  ...
  <div class="app-container">
    ...
    <el-table v-loading="loading" :data="data" size="small" style="width: 100%;">
      ...
      <el-table-column
        ...
        label="微信ID"/>
      <el-table-column
        v-if="checkPermission(['ADMIN','PRIZESUSER_ALL','PRIZESUSER_EDIT','PRIZESUSER_DELETE'])"
        label="操作"
        width="150px"
        align="center">
        <template slot-scope="scope">
          <edit
            v-permission="['ADMIN','PRIZESUSER_ALL','PRIZESUSER_EDIT']"
            :data="scope.row"
            :sup_this="sup_this"/>
          <el-popover
            v-permission="['ADMIN','PRIZESUSER_ALL','PRIZESUSER_DELETE']"
            :ref="scope.row.id"
            placement="top"
            width="180">
            <p>确定删除本条数据吗？</p>
...
import { del } from '@/api/prizesUser'
